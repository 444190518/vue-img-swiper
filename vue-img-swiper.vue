    ...
    <div class="dialog-wrap" v-show='showWin' @mousedown='down' @mouseup='up' @mousemove='move' ref='dialogArea'>
      ...
      <div class="dialog" ref='dialog' :style='{top:top+"px",left:left+"px",width:curWidth+"px",height:curHeight+"px"}'>
        <div class="title-wrap">
          <div class="title" data-type='move'><slot name='title'>标题</slot></div>
        </div>
...
export default {
  ...
  methods: {
    ...
    initSize(){
      var refs=this.$refs;
      var top=(refs.dialogArea.offsetHeight-refs.dialog.offsetHeight)/2;
      var left=(refs.dialogArea.offsetWidth-refs.dialog.offsetWidth)/2;
